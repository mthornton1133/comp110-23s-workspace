...
def main() -> None:
    ...
    while number_of_turns <= 6:
        ...
        players_guessed_word: str = input_guess(len(SECRETWORD))
        print(emojified(players_guessed_word, SECRETWORD))
        if players_guessed_word == SECRETWORD:
            return print(f"You won in {number_of_turns}/6 turns!")
